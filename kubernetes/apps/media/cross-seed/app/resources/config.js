...
module.exports = {
  ...
  torznab: [
    `http://prowlarr.default.svc.cluster.local/9/api?apikey=$${process.env.PROWLARR_API_KEY}`, // 1337
    `http://prowlarr.default.svc.cluster.local/10/api?apikey=$${process.env.PROWLARR_API_KEY}`, // fnp
  ],
